...
//!
//! ```rust,ignore
//! use namra_runtime::{AgentExecutorBuilder, ReActStrategy};
//! use namra_config::AgentConfig;
//! use namra_llm::adapter::LLMAdapter;
//! use namra_tools::builtin::CalculatorTool;
//! use std::sync::Arc;
...
//! tools.insert("calculator".to_string(), Arc::new(CalculatorTool::new()) as Arc<dyn namra_tools::Tool>);
//!
