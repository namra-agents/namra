...
### Unit Tests Summary
- **namra-runtime**: 9 tests, all passing
...
1. **namra-config**: Parse agent YAML
2. **namra-llm**: Call Anthropic Claude API
3. **namra-tools**: Execute tools
4. **namra-runtime**: Orchestrate with ReAct
5. **namra-cli**: User interface
...
### New Files
- `namra-runtime/src/lib.rs` - Module exports and documentation
- `namra-runtime/src/error.rs` - Error types
- `namra-runtime/src/context.rs` - Execution state management
- `namra-runtime/src/executor.rs` - Main executor and builder
- `namra-runtime/src/strategy/mod.rs` - Strategy trait
- `namra-runtime/src/strategy/react.rs` - ReAct implementation

### Modified Files
- `namra-runtime/Cargo.toml` - Added dependencies
- `namra-cli/Cargo.toml` - Added namra-runtime and namra-tools
- `namra-cli/src/commands/run.rs` - Complete rewrite to use executor
